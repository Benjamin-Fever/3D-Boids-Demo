...
void Scene::loadCore() {
    ...
    m_boids.clear();
    for (int n = 0; n < 100; n++) {
        m_boids.emplace_back(linearRand(-m_bound_hsize, m_bound_hsize), sphericalRand(1.0));
    }
...
void Scene::loadCompletion() {
    ...
    m_boids.clear();
    //for (int n = 0; n < 2; n++) {m_boids.emplace_back(linearRand(-m_bound_hsize, m_bound_hsize), sphericalRand(1.0), -1);}
    for (int n = 0; n < 100; n++) {m_boids.emplace_back(linearRand(-m_bound_hsize, m_bound_hsize), sphericalRand(1.0), 0);}
    for (int n = 0; n < 100; n++) {m_boids.emplace_back(linearRand(-m_bound_hsize, m_bound_hsize), sphericalRand(1.0), 1);}
}
...
void Scene::renderGUI() {
	...
	//-------------------------------------------------------------
	ImGui::SliderFloat("Min Speed", &m_min_speed, 0, 7.0, "%.0f");
	ImGui::SliderFloat("Max Speed", &m_max_speed, 0, 10, "%.0f");
	ImGui::SliderFloat("Max Acceleration", &m_max_accaleration, 0, 5, "%.0f");
	ImGui::SliderFloat("Neighbourhood Size", &m_neighbor_radius, 0, 100.0, "%.0f");
	ImGui::SliderFloat("Cohesion Weight", &m_cohesion_weight, 0, 100.0, "%.2f", 3.0f);
	ImGui::SliderFloat("Alignment Weight", &m_alignment_weight, 0, 100.0, "%.2f", 3.0f);
	ImGui::SliderFloat("Avoidance Weight", &m_avoidance_weight, 0, 100.0, "%.2f", 3.0f);
    ImGui::Combo("Containment", &containment, selection);
